...
<template>
    <section>
        <header>
            <h2 class="text-lg font-medium text-gray-900">Troca Senha</h2>

            <p class="mt-1 text-sm text-gray-600">
                Tenha certeza de que sua conta esta usando uma senha grande e aleatória para manter-se seguro.
            </p>
        </header>
